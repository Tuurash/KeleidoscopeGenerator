export function drawRectangle(imageCtx: CanvasRenderingContext2D, img: HTMLImageElement, sx: number, sy: number, sw: number, sh: number, imageCanvas: HTMLCanvasElement) {
...
export function generateRectanglePattern(img: HTMLImageElement, sx: number, sy: number, sw: number, sh: number, zoomLevel: number, rotation: number, patternCanvas: HTMLCanvasElement, patternCtx: CanvasRenderingContext2D) {
